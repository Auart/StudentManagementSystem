...
import com.jixun.controller.CRUDController;
...
public abstract class InputInfoService implements SystemUI {
    ...
    public static void setInfo(String base, String methodName, String afterState) {
        ...
        Tool.backMainMenu(() -> {
            try {
                //重新运行方法(继续)
                StudentDao.class.getDeclaredMethod(methodName).invoke(StudentDao.class.getDeclaredConstructor().newInstance());
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
    ...
    static void getInformation(String methodName, String afterState, Object... args) {
        ...
        try {
            ...
            Tool.judge(Objects.equals(str, "Id"), () -> {
                try {
                    flag[0] = (Boolean) StudentServiceImpl.class.getDeclaredMethod(methodName, Integer.class).invoke(CRUDController.info, args);
                } catch (Exception e) {
                    e.printStackTrace();
                ...
                try {
                    flag[0] = (Boolean) StudentServiceImpl.class.getDeclaredMethod(methodName, String.class).invoke(CRUDController.info, args);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }).run();
