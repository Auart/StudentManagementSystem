...
import com.jixun.data.InfoImpl;
...
public class Tool  {
    ...
    public static void backMainMenu(Runnable again) {
        ...
        Runnable[] runnable = {again, Menu::mainMenu};
    ...
    public static void returnToPrevious(Runnable again, Runnable previous) {
        ...
        Runnable[] runnable = {again, previous, Menu::mainMenu};
        int order = Integer.parseInt(Tool.sc.nextLine());
    ...
    public static void quit() {
        ...
        Runnable[] runnable = {Tool::exit, () -> new Login().login(), Menu::mainMenu};
        int order = Integer.parseInt(Tool.sc.nextLine());
